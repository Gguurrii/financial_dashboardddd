...
export const financialMetrics: FinancialMetric[] = [
  {
    id: '1',
    title: 'Total Revenue',
    value: 45800000, // Base amount in USD
    change: 12.5,
    changeType: 'increase',
    icon: 'TrendingUp',
  ...
  },
  {
    ...
    value: 38200000, // Base amount in USD
    change: 5.2,
    changeType: 'increase',
    icon: 'TrendingDown',
  ...
  },
  {
    id: '3',
    title: 'Net Income',
    value: 7600000, // Base amount in USD
    change: 18.3,
    changeType: 'increase',
    icon: 'DollarSign',
  ...
  },
  {
    id: '4',
    title: 'Cash Reserves',
    value: 12300000, // Base amount in USD
    change: 8.7,
    changeType: 'increase',
    icon: 'Wallet',
...
export const cashFlowData: CashFlowData[] = [
  ...
  { month: 'Oct', income: 6040000, expenses: 3380000, netFlow: 2660000 },
  { month: 'Nov', income: 6430000, expenses: 3450000, netFlow: 2980000 },
